 ...
 * the new 13.5 % VAT percentage.
 */

test("vat-percentages-13.5", async () => {
    ...
    await page.keyboard.type( "Jack VAT 13.5" );
    ...
    await functions.add_product_to_order( page, "VAT 13.5 test 1" );
    ...
    // check amounts
    await functions.check_invoice_amounts( page, order_id, 10, 1.35, 11.35 );
